...
data class Dimensions(
    ...
    val viewExtrasTiny: Dp = 100.dp,
    val viewExtrasSmall: Dp = 110.dp,
    val viewExtrasNormal: Dp = 120.dp,
    val viewExtrasNormalPlus: Dp = 130.dp,
    val viewExtrasBig: Dp = 140.dp,
    val viewExtrasBigPlus: Dp = 150.dp,
    val viewExtrasLarge: Dp = 160.dp,
    val viewExtrasLargePlus: Dp = 170.dp,
